...
def attack(char_name: str, char_class: str) -> str:
    """Attack calculation and output function."""
...
def defence(char_name: str, char_class: str) -> str:
    """Defence calculation and output function."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate special skill and output the result."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Beginning of the training. Start of the game."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Select the name and class for the character."""
    approve_choice: str = ''
    char_class: str = ''
